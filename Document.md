...
9. In the **Security** tab, configure the desired security settings for the virtual network.

10. Click on the **Review + create** button to review your configuration.

11. After reviewing the settings, click on the **Create** button to create the virtual network.
